...
\newcommand{\txtLevel}{3,0}						% Уровень воды в скважине
\newcommand{\txtHorizDepth}{30,0}				% Глубина залегания водоносного горизонта
...
57,0 & 		% 
30,0 & 		% Загружение водоподъемной трубы
32,0 & 		%
26,0 &		% Загружение воздухопроводной трубы
8,0  & 		% Динамический уровень (Уровень + понижение)
