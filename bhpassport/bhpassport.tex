...
\newcommand{\txtDepth}{,0}					% Глубина скважины
\newcommand{\txtDebit}{,0}						% Дебит скважины
\newcommand{\txtLevel}{,0}						% Уровень воды в скважине
\newcommand{\txtHorizDepth}{,0}				% Глубина залегания водоносного горизонта
...
57,0 & 		% 
,0 & 		% Загружение водоподъемной трубы
32,0 & 		%
,0 &		% Загружение воздухопроводной трубы
,0  & 		% Динамический уровень (Уровень + понижение)
5,0  &		% Понижение уровня 
\txtDebit & % Дебит
,0  &		% Удельный дебит
4,0  &		% 
ПКС			% 
