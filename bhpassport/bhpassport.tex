...
%	\end{align}
	...
	\begin{tabular}{|c|c|l|c|c|c|}
		\hline 
		№№ п.п. & Геологический возраст пройденных пород & Описание пройденных пород и характер водоносности & Глубина кровли & Глубина подошвы & Категория пород \\ 
		\hline 
